    ...
    <div class="max-w-4xl mx-auto py-8 space-y-8">
                    ...
                    <div class="flex items-center gap-3 text-sm font-bold text-gray-500">
                        ...
                        @if($hadith->source_url)
                            <a href="{{ $hadith->source_url }}" target="_blank"
                                ...
                                Source Link <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        @empty
            <div class="bg-white p-12 rounded-3xl text-center border border-gray-100">
                <p class="text-gray-400 font-bold text-lg">No hadiths available in this category yet.</p>
            </div>
        @endforelse
    </div>
@endsection