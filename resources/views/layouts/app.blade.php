    ...
    <aside
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto" @click="mobileMenuOpen = false">
            ...
            <a href="{{ route('quran.index') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('quran.*') ? 'bg-indigo-600 text-white shadow-md shadow-indigo-200 font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-indigo-600 font-medium' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('quran.*') ? 'text-white' : 'text-gray-400' }}" fill="none"
            ...
            <a href="{{ route('hadiths.index') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-xl transition {{ request()->routeIs('hadiths.*') ? 'bg-indigo-50 text-indigo-700 font-black' : 'text-gray-500 hover:bg-gray-50 hover:text-indigo-600 font-bold' }}">
